    ...
    <div class="row">
        <div class="col-sm-12 col-xs-12" style="padding-right: 0">
            ...
            <button type="button" class="btn btn-xs btn-default no-print pull-right " id="hide"
                    style="margin-right:15px;border-radius: 0" onclick="">
        ...
        <table class="table">
            ...
            <tr class="thead" style="border-left:none;border-right: none;border-top:none;">
                <th colspan="9"
                    ...
                    <div class="row myhide" style="margin-top: 0px !important;">
                    ...
                    <div class="invoice">
                        <center>
                            <h4 class="title">ប័ណ្ណបញ្ជូនទំនិញ</h4>
                            <h4 class="title" style="margin-top: 3px;">DELIVERY RECEIPT</h4>
                        </center>
                    </div>
                        ...
                        <div class="col-sm-5 col-xs-5">
                            <table class="noPadding" border="none">
                                <tr>
                                    ...
                                    <td style="width: 50%;"><?= $invs->do_reference_no ?></td>
                                </tr>
                                <tr>
                    ...
                    <div id="footer" class="row" style="margin-top: 10px">
                        <div class="col-sm-3 col-xs-3">
                            <center>
                                ...
                                <p style=" margin-top: 4px !important; font-weight: bold; font-family: Khmer OS Siemreap">
                                    អ្នកទិញ</p>
