...
<div id="app_wrapper">
    <header id="header" class="navbar">
        <div class="container">
            ...
            <div class="btn-group visible-xs pull-right btn-visible-gm">
                                ...
                                <ul>
                                    ...
                                    <li class="mm_product_report">
                                        ...
                                        <ul>
                                            ...
                                            <!--<li id="reports_product_grossmargin">
                                                <a href="<?/*= site_url('reports/product_grossmargin') */?>">
                                                    <i class="fa fa-barcode"></i><span class="text"> <?/*= lang('product_grossmargin'); */?></span>
                                                </a>
                                            </li>-->
                                                        ...
                                                        <li id="reports_adjustment_report">
                                                            <a href="<?= site_url('reports/adjustment_report') ?>">
                                                                <i class="fa fa-barcode"></i><span
                                                                        class="text"> <?= lang('adjustment_report'); ?></span>
                                                            </a>
                                                        </li>
                                                    <?php } ?>
