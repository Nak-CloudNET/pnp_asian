        ...
        <table class="table">
                    ...
                    <div class="row" style="margin-top: 0px !important;">
                        ...
                        <!--<div  class="col-sm-7 col-xs-7 company_addr "  style="margin-top: -20px !important;">
                            ...
                            <div class="invoice" style="margin-top:20px;">
                                <center>
                                    <h3 style="font-family: Khmer Mool1">មានលក់សម្ភារៈទឹក ភ្លើង និងបរិក្ខារទឹកស្អាតគ្រប់ប្រភេទ</h3>
                                    <h4 style="margin-top: 3px; font-size: 16px;">HDPE, LDPE, PVC, PPR PIPES AND FITTINGS WITH VALVES ACCESSORIES</h4>
                                </center>
                            </div>
                            <div class="invoice" style="margin-top:20px;">
                                <center>
                                    <h4 class="title">វិក័យប័ត្រ</h4>
                    ...
                    <div class="row" style="text-align: left;">
                        ...
                        <div class="col-sm-5 col-xs-5">
                            <table class="noPadding" border="none">
                                <tr>
                                    <td style="width: 45%;">លេខយោង / Bill No: </td>
            ...
            if ($invs->grand_total != $invs->total) { ?>
                <tr class="border-foot">
                    ...
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold; font-family: Khmer OS Siemreap;">សរុប​ / <?= strtoupper(lang('total')) ?>
                    </td>
            ...
            <?php if ($invs->order_discount != 0) : ?>
                <tr class="border-foot">
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;font-family: Khmer OS Siemreap;">បញ្ចុះតម្លៃ / <?= strtoupper(lang('order_discount')) ?></td>
            ...
            <?php if ($invs->shipping != 0) : ?>
                <tr class="border-foot">
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold; font-family: Khmer OS Siemreap;">ដឹកជញ្ជូន / <?= strtoupper(lang('shipping')) ?></td>
            ...
            <?php if ($invs->order_tax != 0) : ?>
                <tr class="border-foot">
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;font-family: Khmer OS Siemreap;">ពន្ធអាករ / <?= strtoupper(lang('order_tax')) ?></td>
            ...
            <tr class="border-foot">
                ...
                <?php } ?>
                <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;font-family: Khmer OS Siemreap;">តម្លៃសរុប / <?= lang('total') ?>
                </td>
                <td align="right">
                    <?php
            ...
            <?php if($invs->paid != 0 || $invs->deposit != 0){ ?>
                <?php if($invs->deposit != 0) { ?>
                    <tr class="border-foot">
                        <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;font-family: Khmer OS Siemreap;">បានកក់ / <?= lang('deposit') ?>
                        </td>
                ...
                <?php if($invs->paid != 0) { ?>
                    <tr class="border-foot">
                        <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;font-family: Khmer OS Siemreap;">បានបង់ / <?= lang('paid') ?>
                        </td>
                        <td align="right"><?php echo $this->erp->formatMoney($invs->paid-$invs->deposit); ?></td>
                    </tr>
                <?php } ?>
                <tr class="border-foot">
                    <td colspan="<?= $col; ?>" style="text-align: right; font-weight: bold;font-family: Khmer OS Siemreap;">សមតុល្យ / <?= lang('balance') ?>
                    </td>
            ...
            <tr>
                <th colspan="9">
                    ...
                    <div id="footer" class="row" style="margin-top: 10px">
                        <div class="col-sm-3 col-xs-3">
                            <center>
                                <!--<hr style="margin:0; border:1px solid #000; width: 80%">-->
                                <p style=" margin-top: 4px !important; font-weight: bold; font-family: Khmer OS Siemreap">អ្នកទិញ</p>
                                <p style="margin-top:-10px;">Buyer</p>
                            </center>
                        </div>
                        <div class="col-sm-3 col-xs-3">
                            <center>
                                <p style="margin-top: 4px !important">អ្នកទទួល</p>
                                <p style="margin-top:-10px;">Receiver</p>
                            </center>
                        </div>
                        <div class="col-sm-3 col-xs-3">
                            <center>
                                <p style=" margin-top: 4px !important">អ្នកដឹក</p>
                                <p style="margin-top:-10px; ">Transporter</p>
                            </center>
                        </div>
                        <div class="col-sm-3 col-xs-3">
                            <center>
                                <p style=" margin-top: 4px !important">អ្នកលក់</p>
                                <p style="margin-top:-10px; ">Seller</p>
                            </center>
                        </div>
                    </div>
                </th>
