        ...
        <div class="row">
            <table class="table">
                <thead>
                                ...
                                <div  class="col-sm-7 col-xs-7 company_addr "  style="margin-top: -20px !important;">
                                        <div class="invoice" style="margin-top:20px;">
                                            <center>
                                                ...
                                                <h4 class="title" style="margin-top: 3px;">Quotes</h4>
                                            </center>
                    ...
                    <tr class="border thead print" style="background-color: #070795 !important; color: #FFF !important;">
