        ...
        <table class="table">
            ...
            <tr class="thead" style="border-left:none;border-right: none;border-top:none;">
                <th colspan="9"
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12" style="margin-top: -15px; font-size: 13px">
            ...
            if ($invs->grand_total != $invs->total) { ?>
                <tr class="border-foot">
                    ...
                    <td colspan="<?= $col; ?>"
                        style="text-align: right; font-weight: bold; font-family: Khmer OS Siemreap;">តម្លៃសរុប​
                        / <?= lang('total') ?> :
                    </td>
            ...
            <tr>
                <th colspan="9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 col-xs-4" style="padding-right: 0 !important;">
                            <center>
                                <p class="quotedby" style="margin-top: 4px !important">Quoted By:</p>
                            </center>
                        </div>
                    </div>
                    <div id="footer" class="row" style="margin-top: 70px">
                        ...
                        <div class="col-sm-4 col-xs-4" style="padding-right: 0 !important;">
                            <center>
                                ...
                                <p style="margin-top: -1px !important">Sales Manager</p>
                            </center>
                        </div>
                    </div>
                </th>
