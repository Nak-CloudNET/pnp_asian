...
function invoice_concrete_angkor($id=null)
{
    ...
    function pnp_sale_invoice($id=null)
    {
        $this->erp->checkPermissions('add', true, 'sales');
        ...
        $this->data['title'] = "2";
        $this->data['sid'] = $id;
        $this->load->view($this->theme . 'sales/pnp_sale_invoice', $this->data);
    }

    function pnp_sale_invoice_vat($id = null)
    {
        $this->erp->checkPermissions('add', true, 'sales');
        ...
        $this->data['title'] = "2";
        $this->data['sid'] = $id;
        $this->load->view($this->theme . 'sales/pnp_sale_invoice_vat', $this->data);
    }
}